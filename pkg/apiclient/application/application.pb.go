...
type ApplicationQuerySortBy int32

const (
	ApplicationQuery_APP_NAME     ApplicationQuerySortBy = 0
	ApplicationQuery_CREATED_AT   ApplicationQuerySortBy = 1
	ApplicationQuery_SYNCHRONIZED ApplicationQuerySortBy = 2
)

var ApplicationQuerySortBy_name = map[int32]string{
	0: "APP_NAME",
	1: "CREATED_AT",
	2: "SYNCHRONIZED",
}

var ApplicationQuerySortBy_value = map[string]int32{
	"APP_NAME":     0,
	"CREATED_AT":   1,
	"SYNCHRONIZED": 2,
}

func (x ApplicationQuerySortBy) Enum() *ApplicationQuerySortBy {
	p := new(ApplicationQuerySortBy)
	*p = x
	return p
}

func (x ApplicationQuerySortBy) String() string {
	return proto.EnumName(ApplicationQuerySortBy_name, int32(x))
}

func (x *ApplicationQuerySortBy) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(ApplicationQuerySortBy_value, data, "ApplicationQuerySortBy")
	if err != nil {
		return err
	}
	*x = ApplicationQuerySortBy(value)
	return nil
}

func (ApplicationQuerySortBy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_df6e82b174b5eaec, []int{0, 0}
}
...
type ApplicationQuery struct {
	...
	AutoSync []string `protobuf:"bytes,14,rep,name=autoSync" json:"autoSync,omitempty"`
	...
	// sort
	Sort *ApplicationQuerySortBy `protobuf:"varint,18,opt,name=sort,enum=application.ApplicationQuerySortBy" json:"sort,omitempty"`
	// minValue for the watch calls, each value corresponds with sort option
	//
	// Types that are valid to be assigned to MinValue:
	//	*ApplicationQuery_MinAppName
	//	*ApplicationQuery_MinCreatedAt
	//	*ApplicationQuery_MinSynchronizedAt
	MinValue isApplicationQuery_MinValue `protobuf_oneof:"minValue"`
	// maxValue for the watch calls, each value corresponds with sort option
	//
	// Types that are valid to be assigned to MaxValue:
	//	*ApplicationQuery_MaxAppName
	//	*ApplicationQuery_MaxCreatedAt
	//	*ApplicationQuery_MaxSynchronizedAt
	MaxValue isApplicationQuery_MaxValue `protobuf_oneof:"maxValue"`
	// offset for the list call
	Offset *int32 `protobuf:"varint,40,opt,name=offset" json:"offset,omitempty"`
	// limit for the list call
	Limit                *int32   `protobuf:"varint,41,opt,name=limit" json:"limit,omitempty"`
...
type isApplicationQuery_MinValue interface {
	isApplicationQuery_MinValue()
	MarshalTo([]byte) (int, error)
	Size() int
}
type isApplicationQuery_MaxValue interface {
	isApplicationQuery_MaxValue()
	MarshalTo([]byte) (int, error)
	Size() int
}

type ApplicationQuery_MinAppName struct {
	MinAppName string `protobuf:"bytes,20,opt,name=minAppName,oneof" json:"minAppName,omitempty"`
}
type ApplicationQuery_MinCreatedAt struct {
	MinCreatedAt string `protobuf:"bytes,21,opt,name=minCreatedAt,oneof" json:"minCreatedAt,omitempty"`
}
type ApplicationQuery_MinSynchronizedAt struct {
	MinSynchronizedAt string `protobuf:"bytes,22,opt,name=minSynchronizedAt,oneof" json:"minSynchronizedAt,omitempty"`
}
type ApplicationQuery_MaxAppName struct {
	MaxAppName string `protobuf:"bytes,30,opt,name=maxAppName,oneof" json:"maxAppName,omitempty"`
}
type ApplicationQuery_MaxCreatedAt struct {
	MaxCreatedAt string `protobuf:"bytes,31,opt,name=maxCreatedAt,oneof" json:"maxCreatedAt,omitempty"`
}
type ApplicationQuery_MaxSynchronizedAt struct {
	MaxSynchronizedAt string `protobuf:"bytes,32,opt,name=maxSynchronizedAt,oneof" json:"maxSynchronizedAt,omitempty"`
}

func (*ApplicationQuery_MinAppName) isApplicationQuery_MinValue()        {}
func (*ApplicationQuery_MinCreatedAt) isApplicationQuery_MinValue()      {}
func (*ApplicationQuery_MinSynchronizedAt) isApplicationQuery_MinValue() {}
func (*ApplicationQuery_MaxAppName) isApplicationQuery_MaxValue()        {}
func (*ApplicationQuery_MaxCreatedAt) isApplicationQuery_MaxValue()      {}
func (*ApplicationQuery_MaxSynchronizedAt) isApplicationQuery_MaxValue() {}

func (m *ApplicationQuery) GetMinValue() isApplicationQuery_MinValue {
	if m != nil {
		return m.MinValue
	}
	return nil
}
func (m *ApplicationQuery) GetMaxValue() isApplicationQuery_MaxValue {
	if m != nil {
		return m.MaxValue
	}
	return nil
...
func (m *ApplicationQuery) GetAutoSync() []string {
	if m != nil {
		return m.AutoSync
	}
	return nil
...
func (m *ApplicationQuery) GetSort() ApplicationQuerySortBy {
	if m != nil && m.Sort != nil {
		return *m.Sort
	}
	return ApplicationQuery_APP_NAME
}

func (m *ApplicationQuery) GetMinAppName() string {
	if x, ok := m.GetMinValue().(*ApplicationQuery_MinAppName); ok {
		return x.MinAppName
	}
	return ""
}
...
func (m *ApplicationQuery) GetMinCreatedAt() string {
	if x, ok := m.GetMinValue().(*ApplicationQuery_MinCreatedAt); ok {
...
func (m *ApplicationQuery) GetMinSynchronizedAt() string {
	if x, ok := m.GetMinValue().(*ApplicationQuery_MinSynchronizedAt); ok {
		return x.MinSynchronizedAt
	}
	return ""
}

func (m *ApplicationQuery) GetMaxAppName() string {
	if x, ok := m.GetMaxValue().(*ApplicationQuery_MaxAppName); ok {
		return x.MaxAppName
	}
	return ""
}
...
func (m *ApplicationQuery) GetMaxCreatedAt() string {
	if x, ok := m.GetMaxValue().(*ApplicationQuery_MaxCreatedAt); ok {
...
func (m *ApplicationQuery) GetMaxSynchronizedAt() string {
	if x, ok := m.GetMaxValue().(*ApplicationQuery_MaxSynchronizedAt); ok {
		return x.MaxSynchronizedAt
	}
	return ""
}

func (m *ApplicationQuery) GetOffset() int32 {
...
func (m *ApplicationQuery) GetLimit() int32 {
...
func (*ApplicationQuery) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*ApplicationQuery_MinAppName)(nil),
		(*ApplicationQuery_MinCreatedAt)(nil),
		(*ApplicationQuery_MinSynchronizedAt)(nil),
		(*ApplicationQuery_MaxAppName)(nil),
		(*ApplicationQuery_MaxCreatedAt)(nil),
		(*ApplicationQuery_MaxSynchronizedAt)(nil),
	}
}
...
func init() {
	proto.RegisterEnum("application.ApplicationQuerySortBy", ApplicationQuerySortBy_name, ApplicationQuerySortBy_value)
...
var fileDescriptor_df6e82b174b5eaec = []byte{
	...
	,
}
...
func (m *ApplicationQuery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Sort != nil {
		i = encodeVarintApplication(dAtA, i, uint64(*m.Sort))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x90
	...
	if len(m.AutoSync) > 0 {
		for iNdEx := len(m.AutoSync) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AutoSync[iNdEx])
			copy(dAtA[i:], m.AutoSync[iNdEx])
			i = encodeVarintApplication(dAtA, i, uint64(len(m.AutoSync[iNdEx])))
			i--
			dAtA[i] = 0x72
		}
	}
...
func (m *ApplicationQuery_MinAppName) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ApplicationQuery_MinAppName) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.MinAppName)
	copy(dAtA[i:], m.MinAppName)
	i = encodeVarintApplication(dAtA, i, uint64(len(m.MinAppName)))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0xa2
...
func (m *ApplicationQuery_MinCreatedAt) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ApplicationQuery_MinCreatedAt) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *ApplicationQuery_MinSynchronizedAt) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ApplicationQuery_MinSynchronizedAt) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *ApplicationQuery_MaxAppName) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ApplicationQuery_MaxAppName) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.MaxAppName)
	copy(dAtA[i:], m.MaxAppName)
	i = encodeVarintApplication(dAtA, i, uint64(len(m.MaxAppName)))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0xf2
...
func (m *ApplicationQuery_MaxCreatedAt) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ApplicationQuery_MaxCreatedAt) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *ApplicationQuery_MaxSynchronizedAt) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ApplicationQuery_MaxSynchronizedAt) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *ApplicationQuery) Size() (n int) {
	...
	if m.Sort != nil {
		n += 2 + sovApplication(uint64(*m.Sort))
	}
	if m.MinValue != nil {
		n += m.MinValue.Size()
	}
...
func (m *ApplicationQuery_MinAppName) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ApplicationQuery_MinCreatedAt) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ApplicationQuery_MinSynchronizedAt) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ApplicationQuery_MaxAppName) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ApplicationQuery_MaxCreatedAt) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ApplicationQuery_MaxSynchronizedAt) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ApplicationQuery) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			...
			m.AutoSync = append(m.AutoSync, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
		...
		case 18:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= ApplicationQuerySortBy(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinAppName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MinValue = &ApplicationQuery_MinAppName{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 21:
			if wireType != 2 {
			...
			m.MinValue = &ApplicationQuery_MinCreatedAt{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 22:
			if wireType != 2 {
			...
			m.MinValue = &ApplicationQuery_MinSynchronizedAt{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 30:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxAppName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MaxValue = &ApplicationQuery_MaxAppName{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 31:
			if wireType != 2 {
			...
			m.MaxValue = &ApplicationQuery_MaxCreatedAt{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 32:
			if wireType != 2 {
			...
			m.MaxValue = &ApplicationQuery_MaxSynchronizedAt{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 40:
			if wireType != 0 {
